#!/usr/bin/env python3
"""
Fine-tune dmr1000, seed 42, both variants (w / wo methylation pretrain).
Incremental sweep step 1: train these, eyeball the eval curves, THEN decide
whether 1000 steps holds for dmr1000/dmr1000.

Each run in its own subprocess (clean GPU, isolated failures, resumable).
Run:  nohup python finetune_dmr1000.py > ft_dmr1000.log 2>&1 & ; tail -f ft_dmr1000.log
"""
