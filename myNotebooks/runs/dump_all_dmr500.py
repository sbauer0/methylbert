#!/usr/bin/env python3
"""
Dump per-read predictions for the dmr500 models (seed 42, w/wo methylation)
x 3 splits (train/eval/test). Uses dump_predictions.dump_predictions.

Output: /workspace/predictions500/preds_dmr500_s42_{variant}_{split}.csv  (6 files)
Skips existing outputs (resumable on the hourly box).

Run:  python dump_all_dmr500.py
"""
import os
import traceback
