#!/usr/bin/env python3
"""
Fine-tune dmr250, seed 42, both variants (w / wo methylation pretrain).
...
Run:  nohup python finetune_dmr250.py > ft_dmr250.log 2>&1 & ; tail -f ft_dmr250.log
"""
